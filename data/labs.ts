...
export const LAB_DETAIL_DATA: Record<string, LabDetailProps> = {
  ...
  'cmo-roadmap-generator': {
    ...
    year: '2026',
    tagline:
      'Start on the public tool page, run the native intake, then keep a shareable results link or an emailed summary — same deterministic roadmap, no sidecar app.',
    metrics: [
      { value: 'Lab page', label: 'Primary landing' },
      { value: 'Native', label: 'In-app intake' },
      { value: 'Roadmap', label: 'On-site artifact' },
    ],
    problemBody: [
      ...
      'CMO Roadmap Generator lives on this site: the lab detail page is the front door, the intake is the next step in the same experience, and the roadmap renders as a native result — not a bolted-on microsite.',
      'Answer the same framing questions I use with clients, then walk away with a roadmap shaped around your reality — not a generic template.',
    ],
    buildStack: [
      { layer: 'Framework', choice: 'Next.js App Router', why: 'Lab detail, intake flow, and results share one deployable surface with consistent routing and branding' },
      { layer: 'Flow', choice: 'Detail → intake → results', why: 'Public context first, then guided capture, then an artifact users can save or share from the same origin' },
      { layer: 'Hosting', choice: 'Vercel', why: 'Same CDN and preview workflow as the rest of Darling MarTech' },
    ],
    buildBody: [
      'The public tool page sets context and expectations. From there, a native multi-step intake covers goals, audience, channels, constraints, and timing — then synthesizes a prioritized roadmap in-app.',
      'It is a lightweight companion to deeper strategy work: enough to act on from the results view, and a clear path if you want help executing.',
    ],
    impactBody: [
      'Operators get a tangible artifact from a short session without leaving the site — useful for internal alignment and for deciding what to tackle first without committing to a full engagement upfront.',
    ],
    proofStatement: 'That a disciplined intake on your own property can produce a credible roadmap without a months-long strategy project or an external tool URL.',
    ctaLine: 'Want help turning the roadmap into executed work?',
    toolSrc: '/tools/cmo-roadmap-generator',
    serviceIds: ['fractional-cmo', 'brand-strategy'],
