...
export const workIndex: WorkCard[] = [
  ...
  },
  {
    ...
    headline:
      'Live quoting on sales calls — accurate bundles, equipment configs, and institutional tiers without the spreadsheet delay.',
  ...
  },
  {
    ...
    headline:
      'Protocol answers in under two minutes — progressive disclosure, JSON-backed pathways, and no more two-day-a-week triage for the clinical team.',
